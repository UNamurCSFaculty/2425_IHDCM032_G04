...
// dto.setProductId(getTestHarvestProduct().getId());
// dto.setQualityId(getMainTestQualityControl().getQuality().getId());
//
// // TODO: en faut-il pas uploader le document en même temps?
// /*
// * DocumentUpdateDto document = new DocumentUpdateDto();
// * document.setId(getMainTestQualityControl().getDocument().getId()); dto.setDocument(document);
// */
//
