...
/**
 * Cette interface définit des méthodes pour créer, récupérer, mettre à jour et supprimer les
 * informations d'un utilisateur. Les méthodes opèrent sur des objets UserDto, qui servent de data
 * transfer objects pour les données utilisateur.
 */
public interface UserService {
     ...
     *
     * @param userDto Le UserDto contenant les informations du nouvel utilisateur.
     ...
     * @param userDto Le UserDto contenant les informations mises à jour.
