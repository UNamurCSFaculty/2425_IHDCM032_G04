 ...
 * retrieving, updating, and deleting users. It leverages a UserRepository for persistence,
 * a UserMapper for converting between entities and DTOs, and a PasswordEncoder for securing passwords.
 */
public class UserDetailServiceImpl implements UserDetailsService, UserService {
     ...
     *
     * This method searches for a user by their email. If the user is not found, a UsernameNotFoundException
     * is thrown.
     *
     ...
     *
     * This method retrieves all users from the repository and converts them into a list of UserDto objects.
     *
     ...
     * encodes the password if provided, saves the updated user, and returns the updated user as a UserDto.
     *
     ...
     *
     * This method checks if a user with the specified ID exists. If not, it throws a ResourceNotFoundException.
     * Otherwise, it deletes the user from the repository.
     *
     ...
     *
     * This method retrieves the user by the given identifier and the role by its name. If both exist,
     * it adds the role to the user's set of roles and saves the updated user.
     *
