...
/**
 * Cette classe encapsule une carte contenant les erreurs de validation. Chaque clé représente le nom d'un champ et la
 * valeur correspondante est le message d'erreur associé.
 */
