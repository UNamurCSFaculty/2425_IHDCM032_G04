 ...
 * <p>
 * Définit les propriétés communes à tous les types d’utilisateurs
 * (admin, producer, trader, transformer, quality_inspector, exporter, carrier)
 * et configure la désérialisation polymorphique via OpenAPI.
 */
@Data
