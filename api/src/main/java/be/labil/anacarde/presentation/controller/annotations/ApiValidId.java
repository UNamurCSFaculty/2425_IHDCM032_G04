 ...
 *   <li>Swagger/OpenAPI documente le paramètre comme un identifiant requis,
 *       avec la description et l’exemple fournis ({@link Parameter}).</li>
 * </ul>
 * <p>
 * À utiliser pour tous les paramètres de type ID afin d’uniformiser la validation
 * et la documentation.
 */
