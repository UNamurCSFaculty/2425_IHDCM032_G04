...
/**
 * Cette API offre un point d'accès pour l'authentification des utilisateurs. En cas de succès, un
 * token JWT est généré et renvoyé sous forme de cookie HTTP-only, et le détail de l'utilisateur est
