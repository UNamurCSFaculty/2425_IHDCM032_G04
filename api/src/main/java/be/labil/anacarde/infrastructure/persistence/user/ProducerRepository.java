 ...
 * <p>
 * Étend {@code GenericUserRepository} pour fournir les opérations CRUD de base
 * et des méthodes de requête personnalisées spécifiques aux producteurs.
 */
@Repository
public interface ProducerRepository extends GenericUserRepository<Producer> {
	 ...
	 * <p>
	 * Effectue une jointure FETCH sur la coopérative pour charger
	 * l’association en une seule requête.
	 *
	 * @param agriculturalIdentifier l’identifiant agricole du producteur
	 * @return un {@link Optional} contenant le {@link Producer} si trouvé,
	 *         ou vide sinon
	 */
	...
	/**
	 * Récupère tous les producteurs triés par ordre alphabétique
	 * croissant de leur nom de famille.
	 *
	 ...
	 *
	 * @param cooperativeId identifiant de la coopérative
