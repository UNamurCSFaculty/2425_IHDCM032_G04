 ...
 * <p>
 * Fournit les opérations CRUD de base ainsi que des méthodes de recherche personnalisées pour les
 * catégories de news.
 */
@Repository
public interface NewsCategoryRepository extends JpaRepository<NewsCategory, Integer> {
	 ...
	 * <p>
	 * Utile pour éviter la duplication et récupérer une catégorie existante lors de la création ou
	 * de la mise à jour des news.
	 *
	 * @param name
	 *            le nom de la catégorie à rechercher
