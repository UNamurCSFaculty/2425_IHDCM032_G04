...
public interface AuctionRepository extends JpaRepository<Auction, Integer> {
	...
	@Query("""
			    ...
			    ORDER BY a.id DESC
			""")
	List<Auction> findByTraderAndStatus(@Param("traderId") Integer traderId, @Param("status") String status);
	...
	@Query("""
			   ...
			   ORDER BY a.id DESC
			""")
	List<Auction> findByBuyerAndStatus(@Param("buyerId") Integer buyerId, @Param("status") String status);
}
