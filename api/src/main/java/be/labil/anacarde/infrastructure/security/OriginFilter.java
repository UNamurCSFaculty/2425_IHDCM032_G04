 ...
 * <p>
 * Si l’en-tête Origin est présent et ne correspond pas à l’origine de confiance
 * configurée (propriété {@code app.trusted.origin}), la requête est rejetée avec
...
public class OriginFilter extends OncePerRequestFilter {
	 ...
	 * @param res   la réponse HTTP à écrire en cas d’erreur
	 * @param chain la chaîne de filtres à invoquer si l’origine est valide
	 * @throws ServletException en cas d’erreur de filtrage
	 * @throws IOException      en cas d’erreur d’E/S lors de la lecture ou l’écriture
	 */
	@Override
