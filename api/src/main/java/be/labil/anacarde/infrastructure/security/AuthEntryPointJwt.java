 ...
 *     <p>This component is responsible for sending a 401 Unauthorized error response when an
...
public class AuthEntryPointJwt implements AuthenticationEntryPoint {
     ...
     *     <p>This method is invoked when an authentication exception is thrown, indicating that the
     *     user is not authorized to access the requested resource. It sends a 401 Unauthorized
