 ...
 * <p>
 * Étend {@link JpaRepository} pour fournir les opérations CRUD de base sur les coopératives et
 * définit une méthode native pour mettre à jour la date de création directement en base.
 */
public interface CooperativeRepository extends JpaRepository<Cooperative, Integer> {
	/**
	 * Met à jour nativement la date de création ({@code creation_date}) d’une coopérative
