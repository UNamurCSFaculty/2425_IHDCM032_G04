                ...
                <div className="mx-auto">
                    ...
                    >
                        ...
                        <div className="w-1/2 p-2">
                            <form.AppField
                                name="email"
                                children={field => <field.TextField type="email" label="Adresse mail" />}
                            />
                        </div>
                        <div className="w-1/2 p-2">
                            <form.AppField
                        ...
                        {type === 'producer' && <div className="w-1/2 p-2" >
                            <form.AppField
                                name="agriculturalIdentifier"
                                children={field => <field.TextField label="Identifiant agricole" />}
                            />
                        </div>}
                        <div className="w-1/2 p-2">
                            <form.AppField
                                name="password"
                                children={field => <field.TextField type="password" label="Mot de passe" />}
                            />
                        </div>
                        <div className="w-1/2 p-2">
                            <form.AppField
                                name="passwordValidation"
                                children={field => <field.TextField type="password" label="Valider le mot de passe" />}
                            />
                        </div>
