          ...
          return (
            <div className="inline-flex gap-2">
              ...
              >
                ...
                <SelectContent className="w-100 p-4">
                  {MONTHS.map(month => (
                    <SelectItem
                      key={month.value}
  ...
  (
    ...
    return (
      <Input
        ...
        name={name || picker}
        className={cn(
          'focus:bg-accent focus:text-accent-foreground w-[48px] p-1 text-center font-mono text-base tabular-nums caret-transparent [&::-webkit-inner-spin-button]:appearance-none',
          className
        )}
