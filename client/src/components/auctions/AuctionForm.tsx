...
import type { AuctionDtoWritable, ProductDtoReadable, ProducerDetailDtoWritable, HarvestProductDtoWritable } from '@/api/generated'
...
export function AuctionForm({ products }: AuctionFormProps): React.ReactElement<'div'> {
  ...
  const [selectedProduct, setSelectedProduct] = useState<ProductDtoReadable | null>(null);
                  ...
                  children={field => (
                    <field.SelectField
                      options={products.map(product => ({
                        ...
                        label: "Lot n°" + product.id + " - " +  product.type + " " + product.weightKg + " kg @ " + product.store.name,
                      }))}
                      label="Produit"
                ...
                <Table>
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell>{selectedProduct?.type || "N/A"}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>Qualité</TableCell>
                      <TableCell>{selectedProduct?.qualityControlId || "N/A"}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>Quantité déposée</TableCell>
                      <TableCell>{selectedProduct ? selectedProduct.weightKg + " kg" : "N/A"}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>Date de dépôt</TableCell>
                      <TableCell>{selectedProduct?.deliveryDate || "N/A"}</TableCell>  
                    </TableRow>
                    <TableRow>
