...
const AuctionsTable: React.FC<AuctionsTableProps> = ({ tableTitle, showColumnBidder, showColumnBidderPrice, auctions }) => {
                ...
                return (
                  <TableRow key={auction.id}>
                    ...
                    <TableCell>{auction.price.toLocaleString()} CFA</TableCell>
                      ...
                      {showColumnBidder && 
                        <TableCell>
                          {acceptedBid ? acceptedBid.trader.firstName + " " + acceptedBid.trader.firstName : "N/A"}
                        </TableCell>
                      }
                  </TableRow>
                );
