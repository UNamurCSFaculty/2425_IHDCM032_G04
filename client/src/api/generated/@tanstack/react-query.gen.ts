...
): UseMutationOptions<unknown, UpdateFieldError, Options<UpdateFieldData>> => {
  const mutationOptions: UseMutationOptions<
    unknown,
    UpdateFieldError,
...
): UseMutationOptions<unknown, UpdateStoreError, Options<UpdateStoreData>> => {
  const mutationOptions: UseMutationOptions<
    unknown,
    UpdateStoreError,
...
): UseMutationOptions<unknown, UpdateBidError, Options<UpdateBidData>> => {
  const mutationOptions: UseMutationOptions<
    unknown,
    UpdateBidError,
...
): UseMutationOptions<unknown, CreateFieldError, Options<CreateFieldData>> => {
  const mutationOptions: UseMutationOptions<
    unknown,
    CreateFieldError,
...
): UseMutationOptions<unknown, CreateStoreError, Options<CreateStoreData>> => {
  const mutationOptions: UseMutationOptions<
    unknown,
    CreateStoreError,
...
): UseMutationOptions<unknown, CreateBidError, Options<CreateBidData>> => {
  const mutationOptions: UseMutationOptions<
    unknown,
    CreateBidError,
