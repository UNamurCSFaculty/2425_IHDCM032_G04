...
import { type Options, deleteField, getField, updateField, deleteUser, getUser, updateUser, updateUserRoles, deleteStore, getStore, updateStore, addCarrier, deleteRegion, getRegion, updateRegion, deleteQuality, getQuality, updateQuality, deleteQualityControl, getQualityControl, updateQualityControl, deleteProduct, getProduct, updateProduct, deleteLanguage, getLanguage, updateLanguage, deleteDocument, getDocument, updateDocument, deleteCooperative, getCooperative, updateCooperative, deleteContractOffer, getContractOffer, updateContractOffer, deleteAuction, getAuction, updateAuction, acceptAuction, deleteBid, getBid, updateBid, acceptBid, deleteAuctionStrategy, getAuctionStrategy, updateAuctionStrategy, listUsers, createUser, listFields, createField, addRoleToUser, listStores, createStore, listRegions, createRegion, listQualities, createQuality, listProducts, createProduct, listQualityControls, createQualityControl, listLanguages, createLanguage, createDocument, listCooperatives, createCooperative, listContractOffers, createContractOffer, sendContactMessage, logout, authenticateUser, listAuctions, createAuction, listBids, createBid, listAuctionStrategies, createAuctionStrategy, listDocumentsByUser, getCurrentUser, getApplicationData } from '../sdk.gen';
import { type UseMutationOptions, queryOptions, type DefaultError } from '@tanstack/react-query';
import type { DeleteFieldData, DeleteFieldError, DeleteFieldResponse, GetFieldData, UpdateFieldData, UpdateFieldError, DeleteUserData, DeleteUserError, DeleteUserResponse, GetUserData, UpdateUserData, UpdateUserError, UpdateUserResponse, UpdateUserRolesData, UpdateUserRolesError, UpdateUserRolesResponse, DeleteStoreData, DeleteStoreError, DeleteStoreResponse, GetStoreData, UpdateStoreData, UpdateStoreError, AddCarrierData, AddCarrierError, DeleteRegionData, DeleteRegionError, DeleteRegionResponse, GetRegionData, UpdateRegionData, UpdateRegionError, DeleteQualityData, DeleteQualityError, DeleteQualityResponse, GetQualityData, UpdateQualityData, UpdateQualityError, DeleteQualityControlData, DeleteQualityControlError, DeleteQualityControlResponse, GetQualityControlData, UpdateQualityControlData, UpdateQualityControlError, DeleteProductData, DeleteProductError, DeleteProductResponse, GetProductData, UpdateProductData, UpdateProductError, DeleteLanguageData, DeleteLanguageError, DeleteLanguageResponse, GetLanguageData, UpdateLanguageData, UpdateLanguageError, UpdateLanguageResponse, DeleteDocumentData, DeleteDocumentError, DeleteDocumentResponse, GetDocumentData, UpdateDocumentData, UpdateDocumentError, DeleteCooperativeData, DeleteCooperativeError, DeleteCooperativeResponse, GetCooperativeData, UpdateCooperativeData, UpdateCooperativeError, DeleteContractOfferData, DeleteContractOfferError, DeleteContractOfferResponse, GetContractOfferData, UpdateContractOfferData, UpdateContractOfferError, DeleteAuctionData, DeleteAuctionError, DeleteAuctionResponse, GetAuctionData, UpdateAuctionData, UpdateAuctionError, AcceptAuctionData, AcceptAuctionError, DeleteBidData, DeleteBidError, DeleteBidResponse, GetBidData, UpdateBidData, UpdateBidError, AcceptBidData, AcceptBidError, DeleteAuctionStrategyData, DeleteAuctionStrategyError, DeleteAuctionStrategyResponse, GetAuctionStrategyData, UpdateAuctionStrategyData, UpdateAuctionStrategyError, ListUsersData, CreateUserData, CreateUserError, CreateUserResponse, ListFieldsData, CreateFieldData, CreateFieldError, AddRoleToUserData, AddRoleToUserError, AddRoleToUserResponse, ListStoresData, CreateStoreData, CreateStoreError, ListRegionsData, CreateRegionData, CreateRegionError, ListQualitiesData, CreateQualityData, CreateQualityError, ListProductsData, CreateProductData, CreateProductError, ListQualityControlsData, CreateQualityControlData, CreateQualityControlError, ListLanguagesData, CreateLanguageData, CreateLanguageError, CreateLanguageResponse, CreateDocumentData, CreateDocumentError, ListCooperativesData, CreateCooperativeData, CreateCooperativeError, ListContractOffersData, CreateContractOfferData, CreateContractOfferError, SendContactMessageData, SendContactMessageError, LogoutData, AuthenticateUserData, AuthenticateUserError, AuthenticateUserResponse, ListAuctionsData, CreateAuctionData, CreateAuctionError, ListBidsData, CreateBidData, CreateBidError, ListAuctionStrategiesData, CreateAuctionStrategyData, CreateAuctionStrategyError, ListDocumentsByUserData, GetCurrentUserData, GetApplicationDataData } from '../types.gen';
...
export const deleteQualityControlMutation = (options?: Partial<Options<DeleteQualityControlData>>): UseMutationOptions<DeleteQualityControlResponse, DeleteQualityControlError, Options<DeleteQualityControlData>> => {
    const mutationOptions: UseMutationOptions<DeleteQualityControlResponse, DeleteQualityControlError, Options<DeleteQualityControlData>> = {
        mutationFn: async (localOptions) => {
...
export const getQualityControlQueryKey = (options: Options<GetQualityControlData>) => createQueryKey('getQualityControl', options);

export const getQualityControlOptions = (options: Options<GetQualityControlData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const updateQualityControlMutation = (options?: Partial<Options<UpdateQualityControlData>>): UseMutationOptions<unknown, UpdateQualityControlError, Options<UpdateQualityControlData>> => {
    const mutationOptions: UseMutationOptions<unknown, UpdateQualityControlError, Options<UpdateQualityControlData>> = {
        mutationFn: async (localOptions) => {
...
export const deleteLanguageMutation = (options?: Partial<Options<DeleteLanguageData>>): UseMutationOptions<DeleteLanguageResponse, DeleteLanguageError, Options<DeleteLanguageData>> => {
    const mutationOptions: UseMutationOptions<DeleteLanguageResponse, DeleteLanguageError, Options<DeleteLanguageData>> = {
        mutationFn: async (localOptions) => {
...
export const getLanguageQueryKey = (options: Options<GetLanguageData>) => createQueryKey('getLanguage', options);
...
export const updateLanguageMutation = (options?: Partial<Options<UpdateLanguageData>>): UseMutationOptions<UpdateLanguageResponse, UpdateLanguageError, Options<UpdateLanguageData>> => {
    const mutationOptions: UseMutationOptions<UpdateLanguageResponse, UpdateLanguageError, Options<UpdateLanguageData>> = {
        mutationFn: async (localOptions) => {
...
export const acceptAuctionMutation = (options?: Partial<Options<AcceptAuctionData>>): UseMutationOptions<unknown, AcceptAuctionError, Options<AcceptAuctionData>> => {
    const mutationOptions: UseMutationOptions<unknown, AcceptAuctionError, Options<AcceptAuctionData>> = {
        mutationFn: async (localOptions) => {
...
export const acceptBidMutation = (options?: Partial<Options<AcceptBidData>>): UseMutationOptions<unknown, AcceptBidError, Options<AcceptBidData>> => {
    const mutationOptions: UseMutationOptions<unknown, AcceptBidError, Options<AcceptBidData>> = {
        mutationFn: async (localOptions) => {
...
export const listQualityControlsQueryKey = (options: Options<ListQualityControlsData>) => createQueryKey('listQualityControls', options);

export const listQualityControlsOptions = (options: Options<ListQualityControlsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const createQualityControlQueryKey = (options: Options<CreateQualityControlData>) => createQueryKey('createQualityControl', options);

export const createQualityControlOptions = (options: Options<CreateQualityControlData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const createQualityControlMutation = (options?: Partial<Options<CreateQualityControlData>>): UseMutationOptions<unknown, CreateQualityControlError, Options<CreateQualityControlData>> => {
    const mutationOptions: UseMutationOptions<unknown, CreateQualityControlError, Options<CreateQualityControlData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createQualityControl({
                ...options,
                ...localOptions,
...
export const createLanguageMutation = (options?: Partial<Options<CreateLanguageData>>): UseMutationOptions<CreateLanguageResponse, CreateLanguageError, Options<CreateLanguageData>> => {
    const mutationOptions: UseMutationOptions<CreateLanguageResponse, CreateLanguageError, Options<CreateLanguageData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createLanguage({
                ...options,
                ...localOptions,
...
export const sendContactMessageQueryKey = (options: Options<SendContactMessageData>) => createQueryKey('sendContactMessage', options);

export const sendContactMessageOptions = (options: Options<SendContactMessageData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const sendContactMessageMutation = (options?: Partial<Options<SendContactMessageData>>): UseMutationOptions<unknown, SendContactMessageError, Options<SendContactMessageData>> => {
    const mutationOptions: UseMutationOptions<unknown, SendContactMessageError, Options<SendContactMessageData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await sendContactMessage({
                ...options,
                ...localOptions,
...
export const getApplicationDataQueryKey = (options?: Options<GetApplicationDataData>) => createQueryKey('getApplicationData', options);

export const getApplicationDataOptions = (options?: Options<GetApplicationDataData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
