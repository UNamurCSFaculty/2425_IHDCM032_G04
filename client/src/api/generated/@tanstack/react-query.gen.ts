...
export const checkPhoneQueryKey = (options: Options<CheckPhoneData>) =>
  createQueryKey('checkPhone', options)

export const checkPhoneOptions = (options: Options<CheckPhoneData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: checkPhoneQueryKey(options),
  })
}

export const checkEmailQueryKey = (options: Options<CheckEmailData>) =>
  createQueryKey('checkEmail', options)

export const checkEmailOptions = (options: Options<CheckEmailData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: checkEmailQueryKey(options),
  })
}
