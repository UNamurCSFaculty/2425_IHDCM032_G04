 ...
 */
export const deleteQualityControl = <ThrowOnError extends boolean = false>(options: Options<DeleteQualityControlData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteQualityControlResponse, DeleteQualityControlError, ThrowOnError>({
 ...
 */
export const getQualityControl = <ThrowOnError extends boolean = false>(options: Options<GetQualityControlData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<unknown, GetQualityControlError, ThrowOnError>({
        url: '/api/products/{productId}/quality-controls/{id}',
        ...options
    });
};
 ...
 */
export const updateQualityControl = <ThrowOnError extends boolean = false>(options: Options<UpdateQualityControlData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<unknown, UpdateQualityControlError, ThrowOnError>({
        url: '/api/products/{productId}/quality-controls/{id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const deleteLanguage = <ThrowOnError extends boolean = false>(options: Options<DeleteLanguageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteLanguageResponse, DeleteLanguageError, ThrowOnError>({
...
export const getLanguage = <ThrowOnError extends boolean = false>(options: Options<GetLanguageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetLanguageResponse, GetLanguageError, ThrowOnError>({
        url: '/api/languages/{id}',
        ...options
    });
};
...
export const updateLanguage = <ThrowOnError extends boolean = false>(options: Options<UpdateLanguageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateLanguageResponse, UpdateLanguageError, ThrowOnError>({
        url: '/api/languages/{id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const acceptAuction = <ThrowOnError extends boolean = false>(options: Options<AcceptAuctionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<unknown, AcceptAuctionError, ThrowOnError>({
 ...
 * Accepter une offre
 */
export const acceptBid = <ThrowOnError extends boolean = false>(options: Options<AcceptBidData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<unknown, AcceptBidError, ThrowOnError>({
 ...
 */
export const listQualityControls = <ThrowOnError extends boolean = false>(options: Options<ListQualityControlsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<unknown, ListQualityControlsError, ThrowOnError>({
 ...
 */
export const createQualityControl = <ThrowOnError extends boolean = false>(options: Options<CreateQualityControlData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, CreateQualityControlError, ThrowOnError>({
        url: '/api/products/{productId}/quality-controls',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const sendContactMessage = <ThrowOnError extends boolean = false>(options: Options<SendContactMessageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, SendContactMessageError, ThrowOnError>({
        url: '/api/contact',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const listAuctions = <ThrowOnError extends boolean = false>(options?: Options<ListAuctionsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<unknown, ListAuctionsError, ThrowOnError>({
        url: '/api/auctions',
        ...options
    });
};
 ...
 */
export const getApplicationData = <ThrowOnError extends boolean = false>(options?: Options<GetApplicationDataData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApplicationDataResponse, unknown, ThrowOnError>({
        url: '/api/app',
        ...options
    });
};